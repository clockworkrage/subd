...
urlpatterns = patterns('',
	...
	url(r'^db/api/user/unfollow/$', user.user_unfollow, name='user_unfollow'),
	...
	url(r'^db/api/user/listFollowing/$', user.user_listFollowing, name='user_listFollowing'),
	url(r'^db/api/user/listPosts/$', user.user_listPosts, name='user_listPosts'),
	...
	url(r'^db/api/forum/listThreads/$', forum.forum_listThreads, name='forum_listThreads'),
	url(r'^db/api/forum/listUsers/$', forum.forum_listUsers, name='forum_listUsers'),
	...
	url(r'^db/api/thread/listPosts/$', thread.thread_listPosts, name='thread_listPosts'),
